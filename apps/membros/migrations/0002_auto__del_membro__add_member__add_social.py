...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field social on 'Member'
        m2m_table_name = db.shorten_name(u'membros_member_social')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('member', models.ForeignKey(orm[u'membros.member'], null=False)),
            ('social', models.ForeignKey(orm[u'membros.social'], null=False))
        ))
        db.create_unique(m2m_table_name, ['member_id', 'social_id'])

        # Adding model 'Social'
        db.create_table(u'membros_social', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('type_social', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field social on 'Member'
        db.delete_table(db.shorten_name(u'membros_member_social'))
    ...
    models = {
        ...
        u'membros.member': {
            'Meta': {'ordering': "['-user__data_joined']", 'object_name': 'Member'},
            'enterprise': ('django.db.models.fields.CharField', [], {'max_length': '180', 'null': 'True', 'blank': 'True'}),
            'social': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['membros.Social']", 'symmetrical': 'False'}),
        ...
        u'membros.social': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'type_social': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        }
    }

    complete_apps = ['membros']